...
doctype_js = {"Sales Order" : "public/js/hold_permission.js"}
doctype_js = {"Purchase Order" : "public/js/hold_permission.js"}
doctype_js = {"Sales Invoice" : "public/js/hold_permission.js"}
